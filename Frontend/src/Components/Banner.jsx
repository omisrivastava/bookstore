      ...
      <div className=" order-2 md:order-1 w-full md:w-1/2 mt-12 md:mt-32">
        <div className="space-y-12">
          ...
          <p className="text-xl">
            ...
            cum placeat eius! Ullam consequatur magnam eaque expedita
            perferendis suscipit perspiciatis laboriosam, quae nobis soluta
            harum modi quidem repudiandae tempora.
          </p>
